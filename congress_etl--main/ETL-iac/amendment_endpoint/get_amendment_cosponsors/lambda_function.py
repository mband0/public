...
def lambda_handler(event,context):
    ...
    table_name = "amendment_cosponsors"
    columns_list = ['bioguideId','firstName','fullName','isOriginalCosponsor','lastName','middleName','party','sponsorshipDate','state','url']
    columns = "(bioguideid,firstname,fullname,isoriginalcosponsor,lastname,middlename,party,sponsorshipdate,state,url)"
    limit=250
