...
def lambda_handler(event,context):
    ...
    table_name = "amendment_info"
    columns_list = ['actions','amendedBill','chamber','congress','latestAction','number','proposedDate','purpose','sponsors','submittedDate','type','updateDate']
    columns = "(actions,amendedbill,chamber,congress,latestaction,number,proposeddate,purpose,sponsors,submitteddate,type,updatedate)"
    limit=250
