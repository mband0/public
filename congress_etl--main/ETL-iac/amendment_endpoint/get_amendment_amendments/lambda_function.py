...
def lambda_handler(event,context):
    ...
    URL_ENDPOINT = '/amendments'
    table_name = "amendment_amendments"
    columns_list = ['congress','latestAction','number','purpose','type','updateDate','url']
    columns = "(congress,latestaction,number,purpose,type,updatedate,url)"
    limit=250
