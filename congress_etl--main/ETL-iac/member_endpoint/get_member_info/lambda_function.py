...
def lambda_handler(event,context):
    ...
    columns_list = ['addressInformation','bioguideId','birthYear','cosponsoredLegislation','currentMember','depiction','directOrderName','district','firstName','invertedOrderName','lastName','officialWebsiteUrl','partyHistory','state','terms','updateDate']
    columns = "(addressinformation,bioguideid,birthyear,cosponsoredlegislation,currentmember,depiction,directordername,district,firstname,invertedordername,lastname,officialwebsiteurl,partyhistory,state,terms,updatedate)"
    limit=250
