"""Lambda function that calls Bill titles API and writes the data to a db."""
import os
import json
import requests
import boto3
...
def lambda_handler(event,context):
    ...
    columns_list = ["billTextVersionCode","billTextVersionName","chamberCode","chamberName","title","titleType","titleTypeCode","updateDate","congress", "billType", "billNumber", "endpoint_url"]
    columns = "(billTextVersionCode,billTextVersionName,chamberCode,chamberName,title,titleType,titleTypeCode,updateDate,congress,billType,billNumber,endpoint_url)"
    limit = 250
    ...
    for row_data in input_data:
        ...
        while request_url:
            ...
            if response_data:
                titles_data = response_data["titles"]
