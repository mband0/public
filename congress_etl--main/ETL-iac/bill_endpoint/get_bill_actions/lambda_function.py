"""Lambda function that calls Bill Actions API and writes the data to a db."""
import os
import json
import requests
import boto3
...
def lambda_handler(event,context):
    ...
    columns_list = ['type', 'actionTime', 'calendarNumber', 'sourceSystem', 'committees', 'text', 'actionDate', 'actionCode', 'congress', 'billType', 'billNumber', 'endpoint_url']
    columns = "(type,actionTime,calendarNumber,sourceSystem,committees,text,actionDate,actionCode,congress,billType,billNumber,endpoint_url)"
    limit = 250
