"""Lambda function that calls Bill Summaries API and writes the data to a db."""
import os
import json
import requests
import boto3
...
def lambda_handler(event,context):
    ...
    URL_ENDPOINT = '/summaries'
    table_name = "bill_summaries"
    columns_list = ["actionDate","actionDesc","text","updateDate","versionCode","congress", "billType", "billNumber", "endpoint_url"]
    columns = "(actionDate,actionDesc,text,updateDate,versionCode,congress,billType,billNumber,endpoint_url)"
    limit = 250
    ...
    for row_data in input_data:
        ...
        while request_url:
            ...
            if response_data:
                summaries_data = response_data["summaries"]
