"""Lambda function that calls Bill Subjects API and writes the data to a db."""
import os
import json
import requests
import boto3
...
def lambda_handler(event,context):
    ...
    URL_ENDPOINT = '/subjects'
    table_name = "bill_subjects"
    columns_list = ["legislativeSubjects","policyArea","congress", "billType", "billNumber", "endpoint_url"]
    columns = "(legislativeSubjects,policyArea,congress,billType,billNumber,endpoint_url)"
    limit = 250
    ...
    for row_data in input_data:
        ...
        while request_url:
            ...
            if response_data:
                subjects_data = response_data["subjects"]
