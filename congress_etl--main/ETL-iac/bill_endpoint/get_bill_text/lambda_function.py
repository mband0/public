"""Lambda function that calls Bill text API and writes the dta to a db."""
import os
import json
import requests
import boto3
...
def lambda_handler(event,context):
    ...
    columns_list = ["date","format","type","congress", "billType", "billNumber", "endpoint_url"]
    columns = "(date,format,type,congress,billType,billNumber,endpoint_url)"
    limit = 250
    ...
    for row_data in input_data:
        ...
        while request_url:
            ...
            if response_data:
                text_data = response_data["textVersions"]
